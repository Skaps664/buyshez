...
const products: Record<string, {
  ...
  "radiance-serum": {
    ...
    howToUse: "Apply 3-4 drops to cleansed face and neck morning and evening. Gently pat into skin until absorbed. Follow with your favorite buyshez moisturizer. For best results, use consistently for 4-6 weeks.",
